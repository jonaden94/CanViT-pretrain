...
``CanViTForImageClassification`` over a glimpse rollout, trained with DDP epochs on
the on-cluster ILSVRC data and validated against canvit_eval's frozen-probe baseline.
"""
