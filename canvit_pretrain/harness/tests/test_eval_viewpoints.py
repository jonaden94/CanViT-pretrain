...
from canvit_pretrain.harness.eval_viewpoints import (
    HISTORICAL_DEFAULTS,
    OPEN_LOOP,
...
def test_distill_uniform_is_bit_identical_to_the_old_generator():
    from canvit_pretrain.train.viewpoint import make_eval_viewpoints
...
def test_distill_foveated_is_bit_identical_to_the_old_generator():
    from canvit_pretrain.train.viewpoint import make_eval_viewpoints_foveated
