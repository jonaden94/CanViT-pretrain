#!/bin/bash
# TOPUP exp20-cond6-strided: resume 42->49 jobs (exclude slow nodes ggpu109,ggpu124,ggpu132)
set -euo pipefail

# === ESSENTIALS ===
RUN_GROUP=patcher_compare
RUN_NAME=exp20-cond6-strided
...
CFG_LOG_EVERY=512
CFG_NUM_WORKERS=4
EXTRA_ARGS="--model.patcher-name square --model.square-patcher.method strided --model.square-patcher.grid-size-fovea 4 --model.square-patcher.patch-size 8 --model.square-patcher.edge-length-multipliers 4 6 12 24 --model.n-backbone-registers 11"
# =================
