#!/bin/bash
# TOPUP exp20-uniform8: resume 48->49 jobs (exclude slow nodes ggpu109,ggpu124,ggpu132)
set -euo pipefail

# === ESSENTIALS ===
RUN_GROUP=patcher_compare
RUN_NAME=exp20-uniform8
ARRAY=0-0%1                                   # TOPUP: 48 jobs done -> 1 more -> 49 total (200,704)
TIME=0-00:45:00
MEM=128G
NGPU=1
...
CFG_LOG_EVERY=512
CFG_NUM_WORKERS=4
EXTRA_ARGS="--model.patcher-name uniform --backbone-name vitb8"
# =================
