#!/bin/bash
# TOPUP exp20-uniform7: 47 done -> 2 more -> 49 total (200,704 steps)
# +5 min time limit; exclude known slow nodes ggpu103, ggpu116
set -euo pipefail

# === ESSENTIALS ===
RUN_GROUP=patcher_compare
RUN_NAME=exp20-uniform7
ARRAY=0-1%1                                   # TOPUP: 2 tasks x 4096 steps = 8,192 remaining
TIME=0-00:50:00
MEM=128G
NGPU=1
...
CFG_LOG_EVERY=512
CFG_NUM_WORKERS=4
EXTRA_ARGS="--model.patcher-name uniform --backbone-name vitb7"
# =================
