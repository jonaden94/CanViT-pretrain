#!/bin/bash
# TOPUP exp20-cond2-square: resume 44->49 jobs (exclude slow nodes ggpu109,ggpu124,ggpu132)
set -euo pipefail

# === ESSENTIALS ===
RUN_GROUP=patcher_compare
RUN_NAME=exp20-cond2-square
...
CFG_LOG_EVERY=512
CFG_NUM_WORKERS=4
EXTRA_ARGS="--model.patcher-name square --model.square-patcher.method fovi --model.square-patcher.resolution 49 --model.square-patcher.cart-patch-size 6 --model.square-patcher.no-force-patches-less-than-matched"
# =================
