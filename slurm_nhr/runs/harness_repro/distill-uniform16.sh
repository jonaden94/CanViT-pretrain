...
# (python -m canvit_pretrain.harness.run distill) instead of the old train/loop.py.
#
...
#
# Config is IDENTICAL to slurm_nhr/runs/jon_exp22_full_runs/exp22-uniform16.sh; only the
