#!/bin/bash
# like cond4-fovi-film-pos but sinusoidal FiLM encoding (num_freqs=6) instead of fourier
set -euo pipefail

# === ESSENTIALS ===
RUN_GROUP=jon_exp21_modulation
RUN_NAME=exp21-cond4-fovi-film-pos-sinusoidal
ARRAY=0-10%1                                   # 11 remaining of 49 (resume from step 155648); on-the-fly features + validation ON
TIME=0-01:30:00
MEM=128G
NGPU=1
