...
ARRAY=0-17%1                                   # 18 remaining of 49 (resume from step 126976); on-the-fly features + validation ON
TIME=0-01:30:00
MEM=128G
NGPU=1
...
CFG_LOG_EVERY=512
CFG_NUM_WORKERS=4
EXTRA_ARGS="--model.patcher-name uniform --backbone-name vitb6 --glimpse-grid-size 5 --model.n-backbone-registers 44 --webdataset-dir /mnt/lustre-rzg/workspaces/ws/nib00021/u25995-canvit-data-no-features/webdataset-imagenet-1k-no-features"
# =================
