#!/bin/bash
# cond4-reg + ViT trunk adaLN modulation + cross-attn modulation (fourier)
set -euo pipefail

# === ESSENTIALS ===
RUN_GROUP=jon_exp21_modulation
RUN_NAME=exp21-cond4-reg-modulate-trunk-crossattn-fourier
