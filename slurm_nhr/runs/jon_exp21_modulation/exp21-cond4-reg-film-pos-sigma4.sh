#!/bin/bash
# cond4-reg + positional FiLM (fourier 256/sigma4) on the square patches
set -euo pipefail

# === ESSENTIALS ===
RUN_GROUP=jon_exp21_modulation
RUN_NAME=exp21-cond4-reg-film-pos-sigma4
ARRAY=0-3%1                                   # 4 remaining of 49 (resume from step 184320); on-the-fly features + validation ON
TIME=0-01:30:00
MEM=128G
NGPU=1
