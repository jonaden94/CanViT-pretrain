#!/bin/bash
# (11) baseline + coordconv conditioning (x,y,r channels)
...
RUN_NAME=exp19-coordconv
ARRAY=0-27%1                                   # CONTINUE: 45 jobs done (step 184320) -> 28 remaining -> 73 total (299,008 steps, ~300k)
TIME=0-00:45:00
MEM=128G
NGPU=1
...
CFG_LOG_EVERY=512
CFG_NUM_WORKERS=4
EXTRA_ARGS="--model.patcher-name foveated --model.foveated-patcher.resolution 64 --model.foveated-patcher.cart-patch-size 8 --model.foveated-patcher.arch-flag doubleres --model.foveated-patcher.conditioning.mode coordconv"
# =================
