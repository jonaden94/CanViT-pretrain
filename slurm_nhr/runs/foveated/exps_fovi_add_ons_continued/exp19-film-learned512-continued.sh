#!/bin/bash
# (10) baseline + FiLM(learned per-patch code, dim=512)
...
RUN_NAME=exp19-film-learned512
ARRAY=0-2%1                                   # CONTINUE: 70 jobs done (step 286720) -> 3 remaining -> 73 total (299,008 steps, ~300k)
TIME=0-00:45:00
MEM=128G
NGPU=1
