#!/bin/bash
# (9) baseline + FiLM(position, Fourier 256 freqs, sigma=16)
...
RUN_NAME=exp19-film-pos-sigma16
ARRAY=0-7%1                                   # CONTINUE: 65 jobs done (step 266240) -> 8 remaining -> 73 total (299,008 steps, ~300k)
TIME=0-00:45:00
MEM=128G
NGPU=1
