#!/bin/bash
# (9) baseline + FiLM(position, Fourier 256 freqs, sigma=1)
...
RUN_NAME=exp19-film-pos-sigma1
ARRAY=0-24%1                                   # CONTINUE: 48 jobs done (step 196608) -> 25 remaining -> 73 total (299,008 steps, ~300k)
TIME=0-00:45:00
MEM=128G
NGPU=1
