#!/bin/bash
# (19) baseline res64/cart8/doubleres + 14 extra backbone (ViT) registers (n_backbone_registers 5 -> 19)
...
RUN_NAME=exp19-backbone-registers-19
...
CFG_LOG_EVERY=512
CFG_NUM_WORKERS=4
EXTRA_ARGS="--model.patcher-name foveated --model.foveated-patcher.resolution 64 --model.foveated-patcher.cart-patch-size 8 --model.foveated-patcher.arch-flag doubleres --model.n-backbone-registers 19"
# =================
