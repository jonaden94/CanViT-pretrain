#!/bin/bash
# (1) baseline: res64 cart8 doubleres (reproduces exp17 res64-doubleres)
...
RUN_NAME=exp19-baseline-res64-doubleres
ARRAY=0-1%1                                   # CONTINUE: 71 jobs done (step 290816) -> 2 remaining -> 73 total (299,008 steps, ~300k)
TIME=0-00:45:00
MEM=128G
NGPU=1
