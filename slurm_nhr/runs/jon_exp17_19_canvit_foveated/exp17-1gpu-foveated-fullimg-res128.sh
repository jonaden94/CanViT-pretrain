...
# (resolution=128, cart_patch_size=16). Otherwise identical to
...
RUN_GROUP=foveated
RUN_NAME=exp17-1gpu-foveated-fullimg-res128
...
CFG_LOG_EVERY=512
CFG_NUM_WORKERS=4
EXTRA_ARGS="--model.patcher-name foveated --model.foveated-patcher.resolution 128 --model.foveated-patcher.cart-patch-size 16"
# =================
