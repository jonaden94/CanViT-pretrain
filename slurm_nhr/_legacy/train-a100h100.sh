...
#
# Usage:
#   bash slurm_nhr/train.sh [extra args passed to canvit_pretrain.train]
#
# Examples:
#   bash slurm_nhr/train.sh                              # full run, auto run-name
#   bash slurm_nhr/train.sh --steps-per-job 100         # smoke test
