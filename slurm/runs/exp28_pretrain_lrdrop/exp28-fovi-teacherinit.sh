#!/bin/bash
# exp28 PHASE A — from-scratch replication of exp22-fovi-teacherinit at the CURRENT code base.
#
...
# the x0.1 LR drop is a SEPARATE launcher (see exp28-fovi-teacherinit-lrdrop.sh) that seeds from this
...
RUN_NAME=exp28-fovi-teacherinit
ARRAY=0-137%1
TIME=0-02:00:00
MEM=128G
NGPU=1
