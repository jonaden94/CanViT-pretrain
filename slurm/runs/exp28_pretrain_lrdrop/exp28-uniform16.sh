#!/bin/bash
# exp28 PHASE A — from-scratch replication of exp22-uniform16 at the CURRENT code base.
#
...
# the x0.1 LR drop is a SEPARATE launcher (see exp28-uniform16-lrdrop.sh) that seeds from this
