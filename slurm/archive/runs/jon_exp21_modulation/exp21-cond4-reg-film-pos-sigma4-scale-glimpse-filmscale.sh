...
# exp21-cond4-reg-film-pos-sigma4-scale-glimpse ONLY by --...film.encode-scale.
set -euo pipefail

# === ESSENTIALS ===
RUN_GROUP=jon_exp21_modulation
RUN_NAME=exp21-cond4-reg-film-pos-sigma4-scale-glimpse-filmscale
