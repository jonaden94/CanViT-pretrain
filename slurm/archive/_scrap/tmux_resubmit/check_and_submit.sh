#!/bin/bash
# See slurm/tmux_resubmit/README.md for usage.

REPO="/user/henrich1/u25995/jonathan/repos/CanViT-train"
STATE_FILE="$REPO/slurm/canvit_train_state"
SBATCH_SCRIPT="$REPO/slurm/tmux_resubmit/train_v100_tmux_resubmit.sbatch"
# SBATCH_SCRIPT="$REPO/slurm/tmux_resubmit/train_ddp_v100_tmux_resubmit.sbatch"
...
EOF
    ...
    log "Now start the watcher: bash slurm/tmux_resubmit/start_watcher.sh"
    exit 0
fi
