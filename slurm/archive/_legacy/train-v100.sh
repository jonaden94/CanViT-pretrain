...
#
# Usage:
#   bash slurm/train-v100.sh [extra args passed to canvit_pretrain.train]
#
# Examples:
#   bash slurm/train-v100.sh
#   bash slurm/train-v100.sh --run-name my-run
#   bash slurm/train-v100.sh --run-name my-run --steps-per-job 50000
