...
#
# Usage:
#   bash slurm/train.sh [extra args passed to canvit_pretrain.train]
#
# Examples:
#   bash slurm/train.sh                              # full run, auto run-name
#   bash slurm/train.sh --steps-per-job 100         # smoke test
#   bash slurm/train.sh --run-name my-run           # explicit run name (for resume)
#   bash slurm/train.sh --run-name my-run --steps-per-job 50000
