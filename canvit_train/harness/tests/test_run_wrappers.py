...
def test_ade20k_build_model_warns_on_foveated_view_scale(monkeypatch, caplog):
    ...
    import canvit_train.ade20k.task as adetask
...
def test_teacher_init_is_not_broken_by_compile(monkeypatch):
    ...
    compiled: list[str] = []
    monkeypatch.setattr("canvit_train.distill.model.compile_teacher",
    ...
    monkeypatch.setattr("canvit_train.distill.model.load_teacher", lambda cfg: fake)
