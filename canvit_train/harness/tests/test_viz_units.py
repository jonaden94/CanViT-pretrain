"""Tests for canvit_train.distill.viz module."""

import numpy as np
import torch

from canvit_train.distill.viz.image import imagenet_denormalize_to_numpy
from canvit_train.distill.viz.plot import timestep_colors
from canvit_train.harness.viz.metrics import cosine_dissimilarity
from canvit_train.harness.viz.pca import fit_pca, pca_rgb
