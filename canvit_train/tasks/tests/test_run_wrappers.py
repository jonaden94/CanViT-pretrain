...
from canvit_train.ade20k.data import NUM_CLASSES as ADE_CLASSES
from canvit_train.harness.cli import (
    Ade20kCmd,
    Command,
    DistillCmd,
    HarnessOpts,
...
from canvit_train.harness.run import RunTask
...
def test_ade20k_default_spec_reproduces_standalone_lr_schedule():
    ...
    from canvit_train.ade20k.data import make_optimizer_and_scheduler
...
def test_in1k_default_spec_reproduces_standalone_lr_schedule():
    ...
    from canvit_train.train.scheduler import warmup_cosine_scheduler
...
def test_ade20k_build_model_warns_on_foveated_view_scale(monkeypatch, caplog):
    ...
    import canvit_train.tasks.ade20k.task as adetask
...
def test_teacher_init_is_not_broken_by_compile(monkeypatch):
    ...
    compiled: list[str] = []
    monkeypatch.setattr("canvit_train.train.model.compile_teacher",
    ...
    monkeypatch.setattr("canvit_train.train.model.load_teacher", lambda cfg: fake)
