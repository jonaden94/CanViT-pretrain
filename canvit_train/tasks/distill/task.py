...
class DistillRunTask:
    ...
    def build_model(self, device, prior_model_config=None):
        from canvit_train.train.model import create_model, load_student_backbone
    ...
    def build_loaders(self, *, world_size, rank):
        from canvit_train.train.data import create_loaders
        from canvit_train.train.data.webdataset import (
    ...
    def _scene_size_px(self):
        ...
        it is free."""
        from canvit_train.train.data import scene_size_px
    ...
    def viz_frame(self, *, model, images, gout, viewpoint, loss):
        ...
        from canvit_train.train.viz.sample import extract_sample0_viz
    ...
    def viz_init(self, *, model, images, state):
        ...
        from canvit_train.train.viz.image import imagenet_denormalize_to_numpy
        core = getattr(model, "module", model)
        with torch.no_grad():
    ...
    def render_viz(self, viz, *, batch, run_dir, step):
        ...
        from canvit_train.train.viz import plot_multistep_pca, save_figure
    ...
    def evaluate(self, *, model, head, val_loader, device, step, tracker=None, run_dir=None,
        ...
        from canvit_train.train.data import scene_size_px
        from canvit_train.train.probe import load_probe
        from canvit_train.train.tracker import make_tracker
        from canvit_train.train.viz import validate
        try:
