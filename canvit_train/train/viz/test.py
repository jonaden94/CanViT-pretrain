"""Tests for canvit_train.train.viz module."""

import numpy as np
import torch

from canvit_train.train.viz.image import imagenet_denormalize_to_numpy
from canvit_train.train.viz.metrics import cosine_dissimilarity
from canvit_train.train.viz.pca import fit_pca, pca_rgb
from canvit_train.train.viz.plot import timestep_colors
